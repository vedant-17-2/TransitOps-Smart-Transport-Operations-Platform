...
from core.mixins import RoleRequiredMixin, role_required, CSVExportMixin
...
class TripListView(LoginRequiredMixin, RoleRequiredMixin, CSVExportMixin, ListView):
    csv_filename = 'Trip_Report.csv'
    csv_export_fields = [('Trip Number', 'trip_number'), ('Vehicle', 'vehicle.registration_number'), ('Driver', 'driver.name'), ('Source', 'source'), ('Destination', 'destination'), ('Distance (km)', 'distance_km'), ('Status', 'get_status_display')]
    allowed_roles = ['dispatcher', 'fleet_manager']
    model = Trip
...
class TripCreateView(LoginRequiredMixin, RoleRequiredMixin, CreateView):
...
class TripDetailView(LoginRequiredMixin, RoleRequiredMixin, DetailView):
    allowed_roles = ['dispatcher', 'fleet_manager']
    model = Trip
